      ...
      children: [
        ...
        Row(
          children: [
            ...
            SizedBox(width: 14,),
            CustomTextButton(text: '남성', backgroundColor: genders.contains("MALE") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("MALE") ? AppColors.g1 : AppColors.g2,),
            SizedBox(width: 4),
            CustomTextButton(text: '여성', backgroundColor: genders.contains("FEMALE") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("FEMALE") ? AppColors.g1 : AppColors.g2,),
          ],
        ),
        SizedBox(height: 17),
        Row(
          children: [
            ...
            SizedBox(width: 5,),
            CustomTextButton(text: '10대', backgroundColor: ages.contains("TEN") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("TEN") ? AppColors.g1 : AppColors.g2,),
            SizedBox(width: 4),
            CustomTextButton(text: '20대', backgroundColor: ages.contains("TWENTY") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("TEN") ? AppColors.g1 : AppColors.g2,),
            SizedBox(width: 4),
            CustomTextButton(text: '30대', backgroundColor: ages.contains("THIRTY") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("TEN") ? AppColors.g1 : AppColors.g2,),
            SizedBox(width: 4),
            CustomTextButton(text: '40대', backgroundColor: ages.contains("FORTY") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("TEN") ? AppColors.g1 : AppColors.g2,),
            SizedBox(width: 4),
            CustomTextButton(text: '50대', backgroundColor: ages.contains("FIFTY") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("TEN") ? AppColors.g1 : AppColors.g2,),
            SizedBox(width: 4),
            CustomTextButton(text: '50대 이상', backgroundColor: ages.contains("SIXTY") ? AppColors.m3 : AppColors.g6, textColor: genders.contains("TEN") ? AppColors.g1 : AppColors.g2,),
          ],
        ),
      ],
    ),
